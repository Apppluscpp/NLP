...
app.config['MAIL_USERNAME'] = 'oscarkyq-wp21@student.tarc.edu.my'
app.config['MAIL_PASSWORD'] = '(oscar@0708)'
app.config['MAIL_DEFAULT_SENDER'] = 'oscarkyq-wp21@student.tarc.edu.my'  # Set a default sender
...
def send_email(name, email, phone, feedback):
    ...
    body = f"Name: {name}\nEmail: {email}\nPhone: {phone}\nFeedback: {feedback}"
    recipients = ['oscarkyq-wp21@student.tarc.edu.my']
